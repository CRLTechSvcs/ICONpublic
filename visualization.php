...
<h1 class="iconTitle iconTitleShort title_date_display">TEST VISUALIZATION</h1>
					<div class="twelve columns">
<!--AJE 2014-01-17 pub_tabs elements get click functions in calendar_selection_functions.js-->
          ...
          <dl id="pub_tabs" class="tabs five-up contained">
						...
						<dd id="collections_tab"><a href="#collections" id="collections_tab_link">Collections</a></dd>
						<dd id="visualizations_tab"><a href="#visualizations" id="visualizations_tab_link">Visualizations</a></dd>
					</dl>
		...
		<!-- COLLECTIONS TAB -->
						<li id="collectionsTab">
							<div class="row">

<!--
								<div class="twelve columns">
									<div id="collections_header">
										Vendor collections that include any date of this publication: <!--change collections_header.padding-right if change caption
									</div>
								</div>
-->

								<div class="twelve columns" id="collections_header">
										Vendor collections that include any date of this publication: <!--change collections_header.padding-right if change caption-->
								</div>


							</div>
								<div id="collection_display">
									<div id="loading-format-info" class="loading-format-info-invisible">
									  <div class="loading">Loading all collections for this publication . . . <img style="vertical-align: baseline;" src="images/loading_formats.gif"></div>
									</div>
                  <div id="collections_chart_canvas_tab">
                    <!--AJE 2013-11-11
                    content added by Google Charts API script-->
                  </div>
									<div id="collections_list" class="pub_data_content">
									<!--tag rewritten when script output runs-->
								  </div>
							</div>
						</li>
		...
		<!-- VISUALIZATIONS TAB -->
						<li id="visualizations_canvas" style="width:100%;">
							<div class="row">
								<div class="twelve columns">
        			    <?php
        			      include "visualize_tabs.php";
        			    ?>
								</div>
							</div>
						</li>
