...
//end setting DB_NAME, tableChoice, pub_id
	...
	$thisUrl 		  = $_SERVER['PHP_SELF']; // '/IMLS/includes/CRLcatalog/calendar.php' or similar
...
<!--2012-06-08 AJE and CFJ - title now set in calendar.php and calendar_selection_functions.js
