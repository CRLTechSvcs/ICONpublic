<?php
  /*
  CFJ 2014-08-14 09:40:00
  At Bernie's request (through Patricia), create a version of search that filters ICON results to repository_id = FLNEW only.
  */
...
<!--[if gt IE 8]><!--><html class="no-js" lang="en"><!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="stylesheets/icon_with_progress.css">
...
<!-- ICON TEXT -->
			<div class="six columns" style="padding-right: 0px;">
				...
				<h1 class="iconTitle iconTitleShort">TEST
			</div>
		</div>
...
<!--AJE 2015-07-27 : new language widget-->
					...
					<div class="row" id="message_container">
							<div class="three columns offset-by-one" id="progress_bar_container">
								<div id="progressbar">
									<div class="progress-label">0%</div>
								</div>
							</div>
							<div class="nine columns" id="message">
							</div>
					</div>
							...
							<div class="row" id="top_search_results">
								...
								<div class="five columns">
									<ul class="button-group radius" id="sort_button_container">
									  ...
									  <li><a href="#" id="sort_help_button" class="button" data-reveal-id="search_help"><img src="images/question_mark.png" /></a></li>
									</ul>
								</div>
							</div>
...
<?php include "set_selectedPubId.php"; ?>
	<script src="javascripts/search_with_progress_functions.js"></script>
	</body>
</html>