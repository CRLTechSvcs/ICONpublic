...
function displayFormatList(results, textStatus) {
	if ((results.search(/Error/i) != -1) || (results.search(/\<b>Notice/i) != -1 )) {
		...
		if (formats.length > 0) {
			...
			availableFormatsString += '</ul>';
			$('<div class="block"><h4>Available Formats</h4></div><div id="available_formats" class="block"><p></p>' + availableFormatsString + '<p></p></div>').insertBefore($('h4:contains("Genealogy of paper")')[0]);
		}
	}
}
function displayRepositoryList(results, textStatus) {
	if ((results.search(/Error/i) != -1) || (results.search(/\<b>Notice/i) != -1 )) {
		...
		var availableRepositoriesString = "<ul>";
		...
		var repositories = data.repositories;
			...
			availableRepositoriesString += '</ul>';
			$('<div class="block"><h4>Available Repositories and Dates</h4></div><div id="available_repositories" class="block"><p></p>' + availableRepositoriesString + '<p></p></div>').insertBefore($('h4:contains("Genealogy of paper")')[0]);
		}
	}
}
