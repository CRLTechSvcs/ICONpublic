...
<script>
 ...
 //   actually do we need it at all here now in new version? is left from when diaplay*.php pages incorporated statistics header
  ...
  function display_publications_by_keyword( pubs_with_keywordJSON ){ // callback for: get_publications_by_country.php
    var strDebug = 'display_publications_by_keyword: ';
    ...
    for (var i = 0; i < pubs_with_keyword.length; i++) {
      ...
      var this_output_div = '<div class="twelve columns" style="' +thisStyle+ '">';
        ...
        this_output_div += '<p class="four columns statisticsData">' +pubs_with_keyword[i].pub_city+ ', ' +pubs_with_keyword[i].country_name+ '</p>';
        this_output_div += '<p class="two columns statisticsData">' +pubs_with_keyword[i].pub_bgnDate+'&nbsp; to &nbsp;' +pubs_with_keyword[i].pub_endDate+ '</p>';
        this_output_div += '</div>';
  ...
  }//end display_publications_by_keyword
...
$( document ).ready(function() {
  ...
  $.get("get_publications_by_keyword.php", { 'keyword': keyword }, display_publications_by_keyword);
